...
name: vimcord
description: >
    Build, scaffold, migrate, and extend Discord bots using TypeScript and the Vimcord framework (a discord.js v14 wrapper).
...
| MongoDB schemas, CRUD, transactions, extend()                           | `.skills/vimcord/database.md`    |
...
| Client config, status, logging, error handling                          | `.skills/vimcord/client.md`      |
